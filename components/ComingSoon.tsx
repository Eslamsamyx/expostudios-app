    ...
    <div className="relative min-h-screen overflow-hidden" style={{ backgroundColor: '#0F1419' }}>
      ...
      <div className="absolute inset-0">
        ...
        <motion.div
          ...
          style={{
            background: 'linear-gradient(180deg, transparent, #00A6FB, transparent)',
            opacity: 0.3,
          }}
          animate={{
            x: [0, 100, 0],
      ...
      >
        <Image
          ...
          style={{
            maskImage: 'linear-gradient(to top left, rgba(0,0,0,0.4) 0%, rgba(0,0,0,0.2) 30%, transparent 70%)',
            WebkitMaskImage: 'linear-gradient(to top left, rgba(0,0,0,0.4) 0%, rgba(0,0,0,0.2) 30%, transparent 70%)',
          }}
          priority
        />
      </motion.div>
        ...
        >
          ...
          >
            ...
            <motion.div
              ...
              style={{
                background: 'linear-gradient(90deg, transparent, #00A6FB, #7C4DFF, transparent)',
              }}
              animate={{
                x: ['-100%', '100%'],
              }}
            ...
            <motion.div
              ...
              style={{
                background: 'linear-gradient(90deg, transparent, #00E5CC, #7C4DFF, transparent)',
              }}
              animate={{
                x: ['100%', '-100%'],
              }}
            ...
            <div className="p-8 sm:p-12 md:p-16">
              ...
              >
                ...
                <p className="text-lg sm:text-xl font-medium tracking-wide mb-3" style={{ color: '#E8ECEF' }}>
                  Design • Innovate • Experience • Transform
                </p>
                <p className="text-sm sm:text-base font-normal opacity-80 px-4 sm:px-0" style={{ color: '#8A94A6' }}>
                  Creating immersive spaces where creativity meets technology
                </p>
              </motion.div>
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    >
                      {isSubmitted ? "Subscribed ✓" : "Get Access"}
                    </motion.button>
                  </div>
                </div>
