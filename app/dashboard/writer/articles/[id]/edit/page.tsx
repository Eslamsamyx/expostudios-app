...
export default function WriterEditArticlePage() {
  ...
  useEffect(() => {
    ...
    if (session && ['ADMIN', 'WRITER'].includes(session.user.role) && articleId) {
      fetchArticle();
    }
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#121417' }}>
      {/* Header */}
      <header className="p-6 border-b" style={{ borderColor: 'rgba(74, 142, 85, 0.2)' }}>
        ...
        <div className="max-w-7xl mx-auto">
          <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              >
                <h2 className="text-xl font-light mb-4" style={{ color: '#4A8E55' }}>
                  Basic Information
                </h2>
