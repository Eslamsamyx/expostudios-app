...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: 'services.consult' });
...
export default async function ConsultServicePage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
    ...
    <div className="min-h-screen">
      ...
      <section className="relative bg-gradient-to-b from-slate-950 to-indigo-950 pt-32 md:pt-40 pb-20 px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-6 bg-gradient-to-r from-blue-400 via-cyan-400 to-teal-400 bg-clip-text text-transparent">
            {t('title')}
          </h1>
      ...
      {/* Offerings Section - indigo-950 to purple-950 */}
      ...
      <section className="relative bg-gradient-to-b from-purple-950 to-slate-950 py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 bg-gradient-to-r from-cyan-200 via-blue-200 to-indigo-200 bg-clip-text text-transparent">
          ...
          <a
            href={`/${locale}/contact`}
            className="inline-flex items-center justify-center px-8 py-4 text-lg font-medium rounded-lg bg-gradient-to-r from-blue-500 to-cyan-500 text-white hover:opacity-90 shadow-lg hover:shadow-xl transition-all"
          >
            Get in Touch
          </a>
        </div>
